...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground hover:bg-[color:var(--lente-teal-deep)]",
        secondary:
        ...
        ai: "border-transparent bg-[color:var(--lente-coral-soft)] text-[color:var(--lente-coral-deep)]",
      },
    },
    defaultVariants: {
      variant: "default",
