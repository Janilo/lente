      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="flex flex-row flex-nowrap items-center justify-between gap-3 border-t border-border/70 py-6">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="shrink-0 whitespace-nowrap text-[10px] uppercase tracking-[0.24em] text-muted-foreground hover:opacity-70 transition-opacity sm:text-xs sm:tracking-[0.32em]"
          >
            J P Saraiva
          </a>
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.18em] text-muted-foreground sm:text-xs">
            <Link to="/privacidade" className="hover:opacity-70 transition-opacity">
              Privacidade
            </Link>
