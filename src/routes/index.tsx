    ...
    <div>
      <section className="mx-auto max-w-5xl px-6 pt-24 pb-20">
        <div className="max-w-3xl">
          <p className="text-xs uppercase tracking-widest text-muted-foreground">Pesquisa qualitativa · IA</p>
          <h1 className="mt-4 text-6xl md:text-7xl leading-[0.95]">
            Entrevistas em vídeo que <em className="text-primary">se aprofundam</em> sozinhas.
          </h1>
