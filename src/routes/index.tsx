          ...
          <div className="flex items-end justify-between gap-8 mb-10">
            <div>
              ...
              <h2 className="mt-4 text-4xl md:text-5xl leading-[1.05] max-w-2xl">
                Uma síntese <em className="font-display italic text-primary">com evidência em vídeo</em>, não um relatório de PDF.
              </h2>
            </div>
            <p className="hidden md:block text-sm text-muted-foreground max-w-xs">
              Cada insight vem ancorado em clipes citáveis dos próprios entrevistados — você clica e ouve a fala original.
            </p>
          </div>
            ...
            <div className="lg:col-span-3 rounded-md border border-border bg-background overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <h3 className="mt-3 text-2xl leading-tight">
                  Usuários abandonam o onboarding no <em className="font-display italic text-primary">passo de verificação bancária</em>.
                </h3>
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                  Apareceu em 9 das 12 entrevistas. A objeção não é segurança — é falta de contexto sobre por que o dado é pedido naquele momento.
                </p>
                  ...
                  {[
                    ...
                    <div key={c.name} className="flex gap-4 p-3 rounded-sm border border-border bg-card hover:border-primary/40 transition-colors">
                      <div className="relative shrink-0 w-24 h-16 rounded-sm bg-muted flex items-center justify-center">
                        ...
                        <span className="absolute bottom-1 right-1 text-[10px] font-mono text-background bg-foreground/70 px-1 rounded-sm">{c.time}</span>
                      </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="rounded-md border border-border bg-background p-6 shadow-sm">
                ...
                <div className="mt-5 pt-5 border-t border-border flex items-center gap-3">
                  <span className="text-xs px-2 py-1 rounded-sm bg-primary/10 text-primary font-mono">alta confiança</span>
              ...
              <div className="rounded-md border border-border bg-background p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    <div key={m.label} className="flex items-baseline justify-between border-b border-border/60 pb-2 last:border-0">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-md border border-border bg-muted/30 p-6">
              ...
              <div className="mt-4 space-y-2 text-sm text-muted-foreground font-mono leading-relaxed">
                ...
                <p>[00:03:18] entrevistado: ah, foi… começou bem, sabe, gostei do design, mas aí num certo ponto pediram meu banco e eu não entendi…</p>
            ...
            <div className="rounded-md border border-primary/30 bg-background p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-base leading-snug italic">"travei. fechei o app." — Marina, 00:03:38 <span className="text-primary">▶</span></p>
                </div>
                <div>
