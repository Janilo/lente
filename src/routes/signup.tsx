  ...
  head: () => ({
    meta: [
      { title: "Criar conta — Lente" },
      {
        name: "description",
        content:
          "Crie sua conta Lente em segundos e comece a rodar entrevistas em vídeo com follow-ups adaptativos e síntese automática.",
      },
      { property: "og:title", content: "Criar conta — Lente" },
      {
        property: "og:description",
        content:
          "Cadastre-se na Lente para rodar entrevistas em vídeo com síntese automática de insights.",
      },
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-6 py-20">
      ...
      <button
        ...
        className="mt-8 rounded-md border border-border bg-card px-4 py-2.5 text-sm font-medium hover:bg-accent"
      >
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        Já tem conta?{" "}
        <Link to="/login" search={{ returnTo }} className="text-primary underline">
          Entrar
        </Link>
      </p>
